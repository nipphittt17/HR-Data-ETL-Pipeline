...
COPY public."State" FROM '/Users/nipphittt/State.csv' WITH (FORMAT csv, HEADER);
...
COPY public."Country" FROM '/Users/nipphittt/Country.csv' WITH (FORMAT csv, HEADER);
...
COPY public."Employee" FROM '/Users/nipphittt/Employee.csv' WITH (FORMAT csv, HEADER);
...
COPY public."JobProfile" FROM '/Users/nipphittt/JobProfile.csv' WITH (FORMAT csv, HEADER);
...
COPY public."CompanyData" FROM '/Users/nipphittt/CompanyData.csv' WITH (FORMAT csv, HEADER);
